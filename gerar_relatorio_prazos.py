...
AL_E = Alignment(horizontal='left',   vertical='center', wrap_text=True)
...
def _cabec(ws, row, headers):
    for j, h in enumerate(headers, 1):
        _cel(ws, row, j, h, F_CABEC, FONTE_CABEC)
...
def gerar_relatorio(input_source):
    ...
    for col in 'BCDEFGH': ws_r.column_dimensions[col].width = 18
